...
namespace VM2.Framework.DataLayer.Utilitarios.Oracle
{
    ...
    public class DLLog : DLFWBase, IDLLog
    {
        ...
        public List<MLLog> Listar(MLLog pobjParametro)
        {
            ...
            {
                cmdCommand.Parameters.Add(new FWParameter("LOG_C_STACK", FWDbType.Varchar));
        ...
        public int Inserir(MLLog pobjLog)
        {
            ...
            cmdCommand.Parameters.Add(new FWParameter("LOG_N_CODIGO", FWDbType.Int32));
            cmdCommand.Parameters["LOG_N_CODIGO"].Direction = ParameterDirection.Output;

            try
            {
                conProvider.ExecuteNonQuery(cmdCommand);

                if (cmdCommand.Parameters["LOG_N_CODIGO"] != null)
                    intRetorno = Convert.ToInt32(cmdCommand.Parameters["LOG_N_CODIGO"].Value);
